...
-- (Medium) Implement a new command cheat, which moves all game items from the game
-- grid into the user's inventory. Create a function cheat :: Game Unit in the Game
-- module, and use this function from game.
