...
import Test.MySolutions (allTrue, cartesianProduct, countEven, fibTailRec, isEven, isPrime, keepNonNegative, keepNonNegativeRewrite, onlyFiles, primeFactors, reverse, squared, triples, whereIs, (<$?>))
