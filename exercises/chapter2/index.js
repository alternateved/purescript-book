...
(function($PS) {
  ...
  var Data_Semiring = $PS["Data.Semiring"];                
  var ns = function (n) {
      return Data_List.range(0)(n - 1 | 0);
  };
  var multiples = function (n) {
      return Data_List.filter(function (n1) {
          return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(n1)(3) === 0 || Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(n1)(5) === 0;
      })(ns(n));
  };
  var answer = function (n) {
      return Data_Foldable.sum(Data_List_Types.foldableList)(Data_Semiring.semiringInt)(multiples(n));
  };
...
(function($PS) {
  ...
  var Euler = $PS["Euler"];                
  var main = Effect_Console.log("The answer is " + Data_Show.show(Data_Show.showInt)(Euler.answer(1000)));
  exports["main"] = main;
})(PS);
PS["Main"].main();